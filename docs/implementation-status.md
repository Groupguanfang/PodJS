...
| Feasibility / HarmonyOS | Stage module, XComponent/N-API and GLES3 DrawList validator are present | connect runtime boot to NativeWindow, DevEco build and WATCH 5 run |
